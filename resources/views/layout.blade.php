    ...
    <div id="app">
        <div id="sidebar" class="active">
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative py-0" style="height: 100px">
                    <a href="#" style="display: inline-block;height: 100px;line-height: 100px">
                        <img src="{{asset(website_profile() ? website_profile()->logo : 'assets/images/logo/favicon.png')}}" alt="Logo" srcset="" style="width: 50px;height:50px">
                        <h4 class="text-uppercase d-inline-block ms-2">
                            Admin HMIF
                        </h4>
                    </a>
