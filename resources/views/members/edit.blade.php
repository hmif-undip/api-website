...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                <form method="POST" action="{{ url('anggota/'.$member->id) }}" id="form_update_member" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    ...
                    <div class="form-body py-4">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-7">
                                        ...
                                        <input type="text" id="name" class="form-control  @error('name') is-invalid @enderror" name="name" placeholder="Nama" value="{{ old('name') ? old('name') : $member->name }}">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="nim" class="form-label">NIM<span class="text-danger">*</span></label>
                                        <input type="text" id="nim" class="form-control  @error('nim') is-invalid @enderror" name="nim" placeholder="NIM" value="{{ old('nim') ? old('nim') : $member->nim }}">
                                    </div>

                                    <div class="form-group col-md-2">
                                        <label for="birth_date" class="form-label">Tanggal Lahir<span class="text-danger">*</span></label>
                                        <input type="text" id="birth_date" class="form-control  @error('birth_date') is-invalid @enderror" name="birth_date" placeholder="Tanggal Lahir" value="{{ old('birth_date') ? old('birth_date') : $member->birth_date }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <input type="text" id="email" class="form-control  @error('email') is-invalid @enderror" name="email" placeholder="Email" value="{{ old('email') ? old('email') : $member->email }}">
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="telephone" class="form-label">Telepon<span class="text-danger">*</span></label>
                                        <input type="text" id="telephone" class="form-control  @error('telephone') is-invalid @enderror" name="telephone" placeholder="Telepon" value="{{ old('telephone') ? old('telephone') : $member->telephone }}">
                                    </div>

                                    <div class="form-group col-md-4">
                                        <label for="address" class="form-label">Alamat<span class="text-danger">*</span></label>
                                        <textarea class="form-control @error('address') is-invalid @enderror" id="address" rows="3" name="address" placeholder="Address">{{ old('address') ? old('address') : $member->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <div>
                                            <img src="{{asset($member->photo ?? 'assets/images/faces/1.jpg')}}" alt="Foto Saat Ini" width="200px">
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-12 d-flex justify-content-end mt-4">
                            <button type="button" class="btn btn-primary me-1 mb-1" id="submit_update_member" onclick='preventDoubleClick("form_update_member", "submit_update_member")'>Submit</button>
