...
@section('content')
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('anggota-umum') }}">Anggota Umum</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Tambah Anggota Umum</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body">
                <form method="POST" action="{{ url('anggota-umum') }}" id="form_create_general_member">
                    @method('POST')
                    @csrf
                    ...
                    <div class="form-body py-4">
                        ...
                        <div class="col-sm-12 d-flex justify-content-end mt-4">
                            ...
                            <a href="{{ url('anggota-umum') }}" class="btn btn-light-secondary mx-1 mb-1">Back</a>
                        </div>
                    </div>
                </form>
            </div>
